          ...
          itemBuilder: (context,index)=>GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: optionMap[keys[index]]!=null&&optionMap[keys[index]]==true?Colors.teal:Colors.white,
              ...
              child: Row(
                children: [
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: optionMap[keys[index]]!=null&&optionMap[keys[index]]==true?Colors.white:Colors.black,
                  ),
                  ),
